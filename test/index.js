...
(function() {
  var Repository, TreeStore, app, assert, backend, client1BlobStore, client1Branch, client1Repo, client1TreeStore, client2BlobStore, client2Branch, client2Repo, client2TreeStore, contentAddressable, createApp, dataA, dataB, req, serverBlobStore, serverRepo, serverTreeStore, testPort, url, _ref;
  ...
  describe('http-interface', function() {
    ...
    return describe('/trees', function() {
      return it('should do some local commits on client1 and POST the diff to the server', function(done) {
